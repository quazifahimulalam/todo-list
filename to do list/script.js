...
function completeTask(button){
    let tasktext = button.parentElement.previousElementSibling.querySeclector(".task-text")

    let badge = button.parentElement.previousElementSibling.querySeclector(".badge")
